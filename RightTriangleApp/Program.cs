namespace RightTriangleApp
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            if (!double.TryParse(Console.ReadLine(), out double a)) // Απευθείας δήλωση
            {
                Console.WriteLine("Format Error. a must be double.");
            }
            if (!double.TryParse(Console.ReadLine(), out double b)) // Απευθείας δήλωση
            {
                Console.WriteLine("Format Error. b must be double.");
            }
            if (!double.TryParse(Console.ReadLine(), out double c)) // Απευθείας δήλωση
            {
